...
Si tiene Adobe Audience Manager AND Adobe Analytics, puede implementar el reenvío del lado del servidor de los datos de [!DNL Analytics] a Audience Manager. Esto significa que, en lugar de que la página envíe dos visitas (una a [!DNL Analytics] y otra a Audience Manager), puede enviar una visita a [!DNL Analytics] y [!DNL Analytics] reenviará esos datos a Audience Manager.
