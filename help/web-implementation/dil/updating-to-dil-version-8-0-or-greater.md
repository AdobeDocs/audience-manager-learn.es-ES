...
**Sugerencia rápida:** Al usar cualquiera de los métodos anteriores, hizo referencia a la AAM [!UICONTROL Data Source] con el ID [!UICONTROL Data Source] (también conocido como &quot;DPID&quot;). Al actualizar a [!DNL setCustomerIDs], tendrá que usar el &quot;[!UICONTROL Integration Code]&quot; de AAM [!UICONTROL Data Source] en su lugar. Sigue apuntando al mismo(a) [!UICONTROL Data Source], pero es solo un identificador diferente. Esto se muestra en el siguiente vídeo.
